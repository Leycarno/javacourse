...
public class PersonService {
     ...
     */
    public ArrayList<Person> getPeopleWithCar() {
     ...
     */
    public ArrayList<Person> getPeopleWithoutCar() {
    ...
    /**
     * override all persons in the memory
     * @param peopleData
     */
    public void putData(ArrayList<Person> peopleData) {
        people = peopleData;
        nextId += people.size();
    }
}
